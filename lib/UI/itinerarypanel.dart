    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Aseguramos que la vista se construya sin problemas
          isListView
              ? _buildListView()
              : Column(
            children: [
              ...
              if (_selectedDay != null) ...[
                ...
                // Aquí podrías agregar la lista de itinerarios para la fecha seleccionada
              ],
            ],
          ),
        ],
          ...
          itemBuilder: (context, i) {
            ...
            return ListTile(
              leading: Image.network(
                it.experience.experienceImages![0].url.toString(), // Usando la estructura experienceImages![0].url
                width: 56,
                height: 56,
                fit: BoxFit.cover,
                errorBuilder: (_, __, ___) => Container(width: 56, height: 56, color: Colors.grey.shade300),
              ),
              title: Text(it.experience.title.toString()),
